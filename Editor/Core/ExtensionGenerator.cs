    ...
    public static class ExtensionGenerator
    {
        public static string GenerateStatefulView()
        {
            return new TypeGenerator()
                ...
                .AddStatement("public void SetText(TextRole role, string text) => _statefulComponent.SetText(role, text);")
                .AddStatement("public void SetTextValues(TextRole role, params string[] values) => _statefulComponent.SetTextValues(role, values);")
        ...
        public static string GenerateStatefulComponentExtensions()
        {
            return new TypeGenerator()
                ...
                .AddStatement("public static void SetText(this StatefulComponent view, TextRole role, string text) => view.SetRawTextByRole((int)role, text);")
                .AddStatement("public static void SetTextValues(this StatefulComponent view, TextRole role, params string[] args) => view.SetRawTextValuesByRole((int)role, args);")
